...
class Robot
{
    ...
    public function __construct(Crm $app)
    {
        $this->app = $app;
    }
    ...
    public function getTasks(int $pageNum = 1, int $pageSize = 10, string $name = null, int $status = null): array
    {
        ...
        $resp = $this->app->client->get($this->app->url('/api/v1/autoCallTasks'), $parameters);
    ...
    public function postTasks(
        ...
        $resp = $this->app->client->post($this->app->url('/api/v1/autoCallTasks'), $parameters);
        $decoded = json_decode($resp['body'], true);
        if ($decoded['code'] != 200) {
            throw new RuntimeException($decoded['message']);
        }
    ...
    {
        $resp = $this->app->client->get($this->app->url('/api/v1/autoCallTasks/'.$id), []);
        $decoded = json_decode($resp['body'], true);
        if ($decoded['code'] != 200) {
            throw new RuntimeException($decoded['message']);
        }
    ...
    public function updateCallTasks(
        ...
        $resp = $this->app->client->put($this->app->url('/api/v1/autoCallTasks/'.$id), $parameters);
        $decoded = json_decode($resp['body'], true);
        if ($decoded['code'] != 200) {
            throw new RuntimeException($decoded['message']);
        }
    ...
    public function startCallTasks(int $id): ?array
    {
        ...
        $resp = $this->app->client->post($this->app->url('/api/v1/autoCallTasks/status/start/').'&id='.$id, $parameters);
        $decoded = json_decode($resp['body'], true);
        if ($decoded['code'] != 200) {
            throw new RuntimeException($decoded['message']);
        }
    ...
    {
        $resp = $this->app->client->post($this->app->url('/api/v1/autoCallTasks/status/pause')."&id={$id}", []);
        $decoded = json_decode($resp['body'], true);
        if ($decoded['code'] != 200) {
            throw new RuntimeException($decoded['message']);
        }
    ...
    {
        $resp = $this->app->client->post($this->app->url('/api/v1/autoCallTasks/status/archive')."&id={$id}");
        $decoded = json_decode($resp['body'], true);
        if ($decoded['code'] != 200) {
            throw new RuntimeException($decoded['message']);
        }
    ...
    public function getCallTasksNumber(
        ...
        $resp = $this->app->client->get($this->app->url('/api/v1/autoCallTasks/number'), $parameters);
        $decoded = json_decode($resp['body'], true);
        if ($decoded['code'] != 200) {
            throw new RuntimeException($decoded['message']);
        }
    ...
    public function getCallTasksNumberByNumberId(int $numberId): ?array
    {
        ...
        $resp = $this->app->client->get($this->app->url('/api/v1/autoCallTasks/number/'.$numberId));
        $decoded = json_decode($resp['body'], true);
        if ($decoded['code'] != 200) {
            throw new RuntimeException($decoded['message']);
        }
    ...
    public function callTasksSyncNumber(int $outboundTaskId, int $dealType, array $numberList): ?array
    {
        ...
        $resp = $this->app->client->post($this->app->url('/api/v1/autoCallTasks/syncNumber'), $parameters);
        $decoded = json_decode($resp['body'], true);
        if ($decoded['code'] != 200) {
            throw new RuntimeException($decoded['message']);
        }
    ...
    {
        $parameters = compact('outboundTaskId', 'dealType', 'numberList');
        $resp = $this->app->client->post($this->app->url('/api/v1/autoCallTasks/asyncNumber'), $parameters);
        $decoded = json_decode($resp['body'], true);
        if ($decoded['code'] != 200) {
            throw new RuntimeException($decoded['message']);
        }
    ...
    public function getCallTasksSyncNumberResult(int $outboundTaskId, string $batchId): array
    {
        ...
        $resp = $this->app->client->post($this->app->url('/api/v1/autoCallTasks/syncNumberResult'), $parameters);
        $decoded = json_decode($resp['body'], true);
        if ($decoded['code'] != 200) {
            throw new RuntimeException($decoded['message']);
        }
    ...
    public function setTargetUrls(string $payloadUrl, int $id = null): array
    {
        ...
        $resp = $this->app->client->post($this->app->url('/api/v1/targetUrls'), $parameters);
        $decoded = json_decode($resp['body'], true);
        if ($decoded['code'] != 200) {
            throw new RuntimeException($decoded['message']);
        }
    ...
    {
        $resp = $this->app->client->get($this->app->url('/api/v1/spNumbers'), []);
        $decoded = json_decode($resp['body'], true);
    ...
    {
        $resp = $this->app->client->get($this->app->url('/api/v1/worktimes'), []);
        $decoded = json_decode($resp['body'], true);
    ...
    {
        $resp = $this->app->client->get($this->app->url('/api/v1/speechTechniques'), []);
        $decoded = json_decode($resp['body'], true);
    ...
    {
        $resp = $this->app->client->get($this->app->url('/api/v1/outboundCustomFieldTemplates'), []);
        $decoded = json_decode($resp['body'], true);
    ...
    {
        $resp = $this->app->client->get($this->app->url('/api/v1/autoCallTasks/classification'), []);
        $decoded = json_decode($resp['body'], true);
